...
if [ $# -ge 0 ] && [ $# -le 1 ]; then
    ...
    "")
        ...
        str=": Benvenuto nel mio santuario umano, sono Simaris. Sono l'incaricato alla gestione e all'analisi di tutti i dati che il laboratorio raccoglie, ad ogni modo... immagino tu sia qui per il test?"
        ...
        print_animated "$SIMARIS" "$GREEN"
        str=": In ciascuna di queste serie di dati troverai un pezzo della chiave che poi tu stesso dovrai comporre..."
        print_animated "$str" "$WHITE"
        ...
        str=". Per unire questi due potenti strumenti, dovrai utilizzare un terzo strumento, ovvero il carattere "
        print_animated "$str" "$WHITE"
